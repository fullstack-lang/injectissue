...
type FooDB struct {
	...
	// Declation for basic field fooDB.Name {{BasicKind}} (to be completed)
...
func (backRepoFoo *BackRepoFooStruct) CheckoutPhaseOne() (Error error) {
	...
	fooInstancesToBeRemovedFromTheStage := make(map[*models.Foo]struct{})
